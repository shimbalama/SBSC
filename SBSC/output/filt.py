        ...
        for k, v in calls.items():
            if type(v) != list:
                ...
                for i, option in enumerate(v):
                    ...
                    percent_norm = calls.get('read_count_normal')[i][0]/calls.get('read_count_normal')[i][1]
                    percent_tumour = calls.get('read_count_tumour')[i][0]/calls.get('read_count_tumour')[i][1]
                    ...
                    if 0.07 > calls.get('strand')[i] or calls.get('strand')[i] > 0.93:
                        continue
